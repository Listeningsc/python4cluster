...
def process_year(year_info):
    ...
    try:
        ...
        scaler   = StandardScaler()
        feats_scaled_ap = scaler.fit_transform(features.T).T
        pca      = PCA(n_components=0.9)
...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kcenter/grid_search/Geo_T/Hybrid_matrix/Another_pref/AP_Geo_T/sil4simatrix_f5_r_pref'
