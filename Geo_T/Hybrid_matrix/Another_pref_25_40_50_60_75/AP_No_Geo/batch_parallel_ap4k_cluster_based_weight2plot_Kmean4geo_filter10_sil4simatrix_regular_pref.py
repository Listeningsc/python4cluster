...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kcenter/grid_search/Geo_T/Hybrid_matrix/Another_pref/AP_No_Geo/sil4simatrix_f10_r_pref'
