...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kcenter/grid_search/Geo_T/Simatrix/Another_pref/AP_Geo_T/sil4simatrix_filter5_regular_pref'
