...
def optimize_affinity_propagation(coords_rad, pca_features, alpha=0.7):
    ...
    sim_matrix = alpha * geo_sim + (1 - alpha) * feat_sim
...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kcenter/grid_search/Geo_T/Simatrix/Another_pref/AP_Geo_T/sil4simatrix_f10_r_pref'
