...
def process_year(year_info):
    ...
    try:
        ...
        feats_scaled = scaler.fit_transform(feats_kcenter.T).T
...
if __name__ == '__main__':
    ...
    output_path = r'/project/lijiaxing/output/python_output/cluster/AP4Kcenter/grid_search/Kcenter_Geo_T/Simatrix/AP_Geo_T/sil4simatrix_filter10_regular_pref'
