...
def process_year(year_info):
    ...
    try:
        ...
        # feats = tie[:,[0,1,2,6,7,9]]
        scaler   = StandardScaler()
        feats_scaled_kcenter = scaler.fit_transform(feats.T).T
...
if __name__ == '__main__':
    ...
    output_path = r'/project/lijiaxing/output/python_output/cluster/AP4Kplot/AP_geo/sil4hybrid_filter10_extend_pref'
