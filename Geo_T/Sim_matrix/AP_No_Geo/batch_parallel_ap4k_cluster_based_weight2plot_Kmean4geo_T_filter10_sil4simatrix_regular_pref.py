...
def optimize_affinity_propagation(coords_rad, pca_features, alpha=0.7):
    ...
    simatrix = alpha * geo_sim + (1 - alpha) * feat_sim
...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kcenter/grid_search/Kcenter_Geo_T/Simatrix/AP_No_Geo/sil4simatrix_filter10_regular_pref'
