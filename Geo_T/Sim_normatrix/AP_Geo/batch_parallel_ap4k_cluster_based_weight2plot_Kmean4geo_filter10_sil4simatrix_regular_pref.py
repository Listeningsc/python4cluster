...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kcenter/grid_search/Kcenter_Geo_T/Sim_normatrix/AP_Geo/sil4simatrix_filter10_regular_pref'
