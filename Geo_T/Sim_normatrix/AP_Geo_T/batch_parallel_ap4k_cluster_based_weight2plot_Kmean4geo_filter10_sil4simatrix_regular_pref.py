...
def optimize_affinity_propagation(coords_rad, pca_features, alpha=0.7):
    ...
    sim_norm_matrix = alpha * -geo_sim_norm + (1 - alpha) * -feat_sim_norm
    ...
    for i, p in enumerate(percentiles):
        pref = np.percentile(sim_norm_matrix, p)
...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kcenter/grid_search/Kcenter_Geo_T/Sim_normatrix/AP_Geo_T/sil4simatrix_filter10_regular_pref'
