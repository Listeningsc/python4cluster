...
def process_year(year_info):
    ...
    try:
        ...
        for gid in range(K):
            ...
            res = optimize_affinity_propagation(coords_rad[mask], pca_feats[mask])
...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kcenter/grid_search/Kcenter_No_Geo/sim_norm_matrix/sil4simatrix_filter10_regular_pref'
