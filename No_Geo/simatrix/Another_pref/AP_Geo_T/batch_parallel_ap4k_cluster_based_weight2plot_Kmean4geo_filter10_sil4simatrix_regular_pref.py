...
def process_year(year_info):
    ...
    try:
        ...
        tie = np.array(pd.read_csv(csv_file, header=None))
...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kcenter/grid_search/No_Geo/Simatrix/Another_pref/AP_Geo_T/sil4simatrix_f10_r_pref'
