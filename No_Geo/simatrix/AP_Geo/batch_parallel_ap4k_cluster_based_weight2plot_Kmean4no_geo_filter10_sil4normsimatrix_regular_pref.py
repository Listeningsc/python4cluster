...
def optimize_affinity_propagation(coords_rad, pca_features, alpha=0.7):
    ...
    sim_matrix = alpha * (-geo_sim_norm) + (1 - alpha) * (-feat_sim_norm)
    sim_dist = -sim_matrix
...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kplot/grid_search/Kcenter_No_Geo/AP_Geo/sil4normsimatrix_filter10_regular_pref'
