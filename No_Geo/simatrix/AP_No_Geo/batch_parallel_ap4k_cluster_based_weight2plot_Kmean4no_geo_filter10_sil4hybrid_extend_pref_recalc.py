...
def process_year(year_info):
    ...
    try:
        ...
        feature_file = os.path.join(feature_path,f"{year}_cluster_features.mat")
...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kplot/Kcenter_no_geo/sil4hybrid_filter10_extend_pref_recalculate'
