...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kcenter/grid_search/Kcenter_Geo/Sim_normatrix/AP_No_Geo/sil4simatrix_filter5_regular_pref'
