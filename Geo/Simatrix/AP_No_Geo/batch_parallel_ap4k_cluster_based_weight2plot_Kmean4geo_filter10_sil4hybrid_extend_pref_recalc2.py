...
def process_year(year_info):
    ...
    try:
        ...
        # feats_kcenter = tie[:,[0,1,2,6,7,9]]
        scaler   = StandardScaler()
        feats_scaled_kcenter = scaler.fit_transform(feats_kcenter)
        pca      = PCA(n_components=0.9)
        pca_feats_kcenter= pca.fit_transform(feats_scaled_kcenter)
        
        feats_ap = tie[:,[2,6,7,9]]
        scaler   = StandardScaler()
...
if __name__ == '__main__':
    ...
    output_path = r'/scratch/lijiaxing/output/python_output/cluster/AP4Kplot/Kcenter_geo/sil4hybrid_filter10_extend_pref/recalculate2'
